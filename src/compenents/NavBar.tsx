...
<nav className="navbar navbar-expand-lg navbar-light bg-light" style={{marginBottom:"32px", height:"75px",width:"100%",position:"fixed", zIndex:"2", }}>
  <div className="container-fluid" style={{direction:"rtl",backgroundColor:"#ffff",boxShadow:"rgb(58, 58, 58,14%) 1px 2px 10px 1px"}}>
